...
module SolidusPaypalBraintree
  class Gateway < ::Spree::PaymentMethod
    ...
    # Which checkout flow to use (vault/checkout_with_paypal)
    preference(:flow, :string, default: 'vault')
    ...
    def transaction_options(source, options, submit_for_settlement = false)
      ...
      params[:options] = { store_in_vault_on_success: (preferred_flow == 'vault') }
    ...
    def customer_profile_params(payment)
      ...
      if preferred_flow == 'vault' && payment.source.try(:nonce)
